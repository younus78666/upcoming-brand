...
export interface BlogArticle {
  ...
  route?: string;
  /** Featured image URL (relative, e.g. /website-cost-3-paths.webp). Shown on blog card and article top. */
  image?: string;
  imageAlt?: string;
...
export const articles: BlogArticle[] = [
  ...
  { slug: 'attorney-website-design-cost', title: 'Attorney Website Design Cost: What Law Firms Actually Pay in 2026', category: 'buying-guides', description: 'Attorney website design costs $3,500 to $12,000 for a custom WordPress build. What every law firm site must include, schema breakdown, and 6 questions to ask before signing.', status: 'published', route: '/blog/attorney-website-design-cost/', image: '/blog/attorney-website-design-cost/hero.webp', imageAlt: 'Attorney website design cost guide 2026', relatedServices: ['/services/wordpress-web-design/'], relatedIndustries: ['/industries/law-firm-website-design/'] },
  { slug: 'dental-website-design-company', title: 'Dental Website Design Company: How to Choose the Right One in 2026', category: 'buying-guides', description: 'What every dental website design company should include: Dentist schema, HIPAA forms, booking integration. PBHS vs ProSites vs custom WordPress. 6 questions before signing.', status: 'published', route: '/blog/dental-website-design-company/', image: '/blog/dental-website-design-company/hero.webp', imageAlt: 'Dental website design company guide 2026', relatedServices: ['/services/wordpress-web-design/'], relatedIndustries: ['/industries/dental-website-design/'] },
  { slug: 'dental-website-design-cost', title: 'Dental Website Design Cost: 2026 Pricing for Practices', category: 'buying-guides', description: 'What dental practices pay for a real website with online booking, MedicalProcedure schema, and HIPAA-aware forms.', status: 'coming-soon', estPublishMonth: '2026-07', relatedIndustries: ['/industries/dental-website-design/'] },
