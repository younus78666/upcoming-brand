...
export const articles: BlogArticle[] = [
  ...
  { slug: 'attorney-website-design-cost', title: 'Attorney Website Design Cost: What Law Firms Actually Pay in 2026', category: 'buying-guides', description: 'Attorney website design costs $3,500 to $12,000 for a custom WordPress build. What every law firm site must include, schema breakdown, and 6 questions to ask before signing.', status: 'published', route: '/blog/attorney-website-design-cost/', relatedServices: ['/services/wordpress-web-design/'], relatedIndustries: ['/industries/law-firm-website-design/'] },
